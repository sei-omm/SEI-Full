...
const banner_info = [
  {
    ...
    heading: "Engineering the Oceans, <br /> Shaping the Future",
    subheading:
...
//     date: "14 July, 2024",
//     description:
//       "VACANCIES-ENGINEERING & NAUTICAL FACULTY AT FARIDABAD. QUALIFICATIONS AND EXPERIENCE: CHIEF ENGINEER OR CAPTAIN WITH AT LEAST 1 YR. RANK EXPERIENCE ON DIFFERENT TYPES OF SHIPS (LNG/LPG/TANKERS)",
//   },
//   {
            ...
            >
              <div className="relative h-full main-layout flex flex-col justify-center space-y-3 pt-5">
                ...
                <h3
                  className={`text-gray-300 tracking-widest max-w-[40rem] ${
                    current === index
                      ? "opacity-100 blur-none"
                      : "opacity-0 blur-lg"
                  } transition-all duration-1000 sm:max-w-full`}
                >
                ...
                <div className="pt-3 flex items-center flex-wrap gap-y-5 gap-x-5">
                  <Link className="inline-block" href={"/our-courses/kolkata"}>
                    <Button
                      className={`${
                        index === current
                          ? "blur-none opacity-100 duration-1000"
                          : "blur-lg opacity-0 duration-1000"
                      }`}
                      varient="light"
                    >
