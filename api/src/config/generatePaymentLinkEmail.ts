...
export const generatePaymentLinkEmail = (templateData: ejs.Data): Promise<string> => {
    const templatePath = path.resolve(__dirname, "../../public/templates/payment-link.html");
