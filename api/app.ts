        ...
        "faculty_details": [
            {
                ...
                "profile_image": "https://wgli5hygbpaa0ifp.public.blob.vercel-storage.com/studient-icon-oWRZc5AHP4eSi1nHHBSb2sBBVq4NXg.jpg",
            ...
            },
            {
                ...
                "faculty_id": 22,
                "faculty_name": "Fac 1",
                "profile_image": "https://wgli5hygbpaa0ifp.public.blob.vercel-storage.com/employee-profile/Screenshot%20(5)-fOLyGUb93Z4UW3jVQm1FLtFPu55774.png",
            ...
            },
            {
                ...
                "profile_image": "https://wgli5hygbpaa0ifp.public.blob.vercel-storage.com/employee-profile/Screenshot%20(4)-EtPeiEzIauDkAvJyM9RvBdHYxRcGya.png",
                "max_teaching_hrs_per_week": "18",
                "faculty_current_working_hours": 0
            }
        ]
        ...
        subjects.forEach(subject => {
            ...
            output.faculty_details.forEach(loopFac => {
                ...
                if (loopFac.subject.includes(subject)) {
                    ...
                    const myCurrentPosition = time_table.faculty.filter(item => item.for_subject_name === subject).length;
...
app.listen(8080, () => console.log("http://localhost:8001"))