...
const ChooseFileInputNew = forwardRef<any, IProps>(
  (
    {
      viewOnly,
      id,
    ...
    return (
      <div>
        ...
        <label
          ...
          className={`flex cursor-pointer relative overflow-hidden items-center justify-between border-2 ${
            error ? "border-red-300" : "border-gray-200"
          } text-gray-500 rounded-lg w-full text-sm px-4 py-3`}
        >
...
ChooseFileInputNew.displayName = "ChooseFileInputNew"


export default ChooseFileInputNew;
